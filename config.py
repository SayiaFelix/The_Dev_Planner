...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://moringa:safu@localhost/chirry'
...
class TestConfig(Config):
      SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://moringa:safu@localhost/chirry_test'
